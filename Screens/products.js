...
export default ({ navigation }) => {
  ...
  const deleteData = (index) => {
    ...
    fetch(
      `https://reactnativefirstdatabase-a7b2b-default-rtdb.firebaseio.com/ProductDetails/${subid}.json`,
      requestOptions
    )
  ...
  const getproduct = () => {
    fetch(
      `https://reactnativefirstdatabase-a7b2b-default-rtdb.firebaseio.com/ProductDetails.json`,
      {
        method: "GET",
      }
    )
